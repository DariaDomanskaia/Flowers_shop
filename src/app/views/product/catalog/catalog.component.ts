...
export class CatalogComponent implements OnInit {
  ...
  favoritesProducts: FavoriteType[] | null = null;
            ...
            .subscribe(
              {
                next: (data: FavoriteType[] | DefaultResponseType) => {
                  ...
                  this.favoritesProducts = data as FavoriteType[];
                  this.processCatalog();
    ...
    this.categoryService.getCategoriesWithTypes()
      ...
      .subscribe(data => {
        ...
        this.activatedRoute.queryParams.subscribe(params => {
          ...
          this.productService.getAllProducts(this.activeParams)
            .subscribe(data => {
              this.pages = [];
              ...
              if (this.favoritesProducts){
                this.products = this.products.map(product => {
                  const productInFavorites = this.favoritesProducts?.find(item => item.id === product.id);
